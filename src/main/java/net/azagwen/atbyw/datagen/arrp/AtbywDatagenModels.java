...
public class AtbywDatagenModels {
                ...
                if (id.getNamespace().equals("minecraft")) {
                    if (id.getPath().contains("log") || id.getPath().contains("stem")) {
                        if (id.getPath().contains("stripped")) {
                            AtbywDatagenModels.createStrippedLogSlabModels(AtbywRRP.ATBYW_RESOURCE_PACK, id.getNamespace(), id.getPath());
                        } else {
                            AtbywDatagenModels.createPillarSlabModels(AtbywRRP.ATBYW_RESOURCE_PACK, id.getNamespace(), id.getPath());
                        }
                    }
                }
            }
