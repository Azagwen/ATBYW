...
public class RecipesStonecuttingRegistry {
    ...
    public static JsonObject[] TERRACOTTA_STAIRS_COLORS_STONECUTTING = createStonecutterColoredRecipes(new Pair<>("minecraft", "terracotta"), new Pair<>(nameSpace, "terracotta_stairs"), 1);
    public static JsonObject[] TERRACOTTA_SLAB_COLORS_STONECUTTING = createStonecutterColoredRecipes(new Pair<>("minecraft", "terracotta"), new Pair<>(nameSpace, "terracotta_slab"), 2);
    public static JsonObject[] TERRACOTTA_BRICKS_COLORS_STONECUTTING = createStonecutterColoredRecipes(new Pair<>("minecraft", "terracotta"), new Pair<>(nameSpace, "terracotta_bricks"), 1);
    public static JsonObject[] TERRACOTTA_BRICKS_STAIRS_COLORS_STONECUTTING_TERRACOTTA = createStonecutterColoredRecipes(new Pair<>("minecraft", "terracotta"), new Pair<>(nameSpace, "terracotta_bricks_stairs"), 1);
    public static JsonObject[] TERRACOTTA_BRICKS_SLAB_COLORS_STONECUTTING_TERRACOTTA = createStonecutterColoredRecipes(new Pair<>("minecraft", "terracotta"), new Pair<>(nameSpace, "terracotta_bricks_slab"), 2);
    public static JsonObject[] TERRACOTTA_BRICKS_WALL_COLORS_STONECUTTING_TERRACOTTA = createStonecutterColoredRecipes(new Pair<>("minecraft", "terracotta"), new Pair<>(nameSpace, "terracotta_bricks_wall"), 1);
    public static JsonObject[] TERRACOTTA_BRICKS_STAIRS_COLORS_STONECUTTING_TERRACOTTA_BRICKS = createStonecutterColoredRecipes(new Pair<>(nameSpace, "terracotta_bricks"), new Pair<>(nameSpace, "terracotta_bricks_stairs"), 1);
    public static JsonObject[] TERRACOTTA_BRICKS_SLAB_COLORS_STONECUTTING_TERRACOTTA_BRICKS = createStonecutterColoredRecipes(new Pair<>(nameSpace, "terracotta_bricks"), new Pair<>(nameSpace, "terracotta_bricks_slab"), 2);
    public static JsonObject[] TERRACOTTA_BRICKS_WALL_COLORS_STONECUTTING_TERRACOTTA_BRICKS = createStonecutterColoredRecipes(new Pair<>(nameSpace, "terracotta_bricks"), new Pair<>(nameSpace, "terracotta_bricks_wall"), 1);

    public static JsonObject[] CONCRETE_STAIRS_COLORS_STONECUTTING = createStonecutterColoredRecipes(new Pair<>("minecraft", "concrete"), new Pair<>(nameSpace, "concrete_stairs"), 1);
    public static JsonObject[] CONCRETE_SLAB_COLORS_STONECUTTING = createStonecutterColoredRecipes(new Pair<>("minecraft", "concrete"), new Pair<>(nameSpace, "concrete_slab"), 2);
    public static JsonObject[] CINDER_BLOCKS_COLORS_STONECUTTING = createStonecutterColoredRecipes(new Pair<>("minecraft", "concrete"), new Pair<>(nameSpace, "cinder_bricks"), 1);
    public static JsonObject[] CINDER_BLOCKS_WALL_COLORS_STONECUTTING_CONCRETE = createStonecutterColoredRecipes(new Pair<>("minecraft", "concrete"), new Pair<>(nameSpace, "cinder_blocks_wall"), 1);
    public static JsonObject[] CINDER_BLOCKS_WALL_COLORS_STONECUTTING_CINDER_BLOCKS = createStonecutterColoredRecipes(new Pair<>(nameSpace, "cinder_bricks"), new Pair<>(nameSpace, "cinder_blocks_wall"), 1);
    ...
    public static JsonObject BEE_STATUE_FROM_STONECUTTING = createStonecutterRecipe(getBlockID(Blocks.STONE), getBlockID(StatueRegistry.BEE_STATUE), 1);
    public static JsonObject SILVERFISH_STATUE_FROM_STONECUTTING = createStonecutterRecipe(getBlockID(Blocks.STONE), getBlockID(StatueRegistry.SILVERFISH_STATUE), 1);
    public static JsonObject ENDERMITE_STATUE_FROM_STONECUTTING = createStonecutterRecipe(getBlockID(Blocks.STONE), getBlockID(StatueRegistry.ENDERMITE_STATUE), 1);
    public static JsonObject WOLF_STATUE_FROM_STONECUTTING = createStonecutterRecipe(getBlockID(Blocks.STONE), getBlockID(StatueRegistry.WOLF_STATUE), 1);
    public static JsonObject CAT_STATUE_FROM_STONECUTTING = createStonecutterRecipe(getBlockID(Blocks.STONE), getBlockID(StatueRegistry.CAT_STATUE), 1);
    public static JsonObject FOX_STATUE_FROM_STONECUTTING = createStonecutterRecipe(getBlockID(Blocks.STONE), getBlockID(StatueRegistry.FOX_STATUE), 1);
    ...
    public static void injectRecipes(Map<Identifier, JsonElement> map) {
        ...
        putRecipe(AtbywID("chiseled_packed_ice_bricks_stonecutting"), CHISELED_PACKED_ICE_BRICKS_STONECUTTING, map);
        putRecipe(AtbywID("chiseled_blue_ice_bricks_stonecutting"), CHISELED_BLUE_ICE_BRICKS_STONECUTTING, map);
        putRecipe(AtbywID("chiseled_packed_ice_bricks_stonecutting_packed_ice"), CHISELED_PACKED_ICE_BRICKS_STONECUTTING_PACKED_ICE, map);
        putRecipe(AtbywID("chiseled_blue_ice_bricks_stonecutting_blue_ice"), CHISELED_BLUE_ICE_BRICKS_STONECUTTING_BLUE_ICE, map);
        ...
        putRecipe(AtbywID("bee_statue_stonecutting"), BEE_STATUE_FROM_STONECUTTING, map);
        putRecipe(AtbywID("silverfish_statue_stonecutting"), SILVERFISH_STATUE_FROM_STONECUTTING, map);
        putRecipe(AtbywID("endermite_statue_stonecutting"), ENDERMITE_STATUE_FROM_STONECUTTING, map);
        putRecipe(AtbywID("wolf_statue_stonecutting"), WOLF_STATUE_FROM_STONECUTTING, map);
        putRecipe(AtbywID("cat_statue_stonecutting"), CAT_STATUE_FROM_STONECUTTING, map);
        putRecipe(AtbywID("fox_statue_stonecutting"), FOX_STATUE_FROM_STONECUTTING, map);
    }
}
