...
public class StatueRegistry {
    ...
    public static final Block WAXED_CLEAN_AXOLOTL_STATUE = new WaxedStatueBlock(StatueBlockMobTypes.AXOLOTL, statueSettings);
    public static final Block WAXED_EXPOSED_AXOLOTL_STATUE = new WaxedStatueBlock(StatueBlockMobTypes.AXOLOTL, statueSettings);
    public static final Block WAXED_DIRTY_AXOLOTL_STATUE = new WaxedStatueBlock(StatueBlockMobTypes.AXOLOTL, statueSettings);
    public static final Block WAXED_MOSSY_AXOLOTL_STATUE = new WaxedStatueBlock(StatueBlockMobTypes.AXOLOTL, statueSettings);
    public static final Block WAXED_VERY_MOSSY_AXOLOTL_STATUE = new WaxedStatueBlock(StatueBlockMobTypes.AXOLOTL, statueSettings);
    public static final Block AXOLOTL_STATUE = new StatueBlock(false, StatueBlockMobTypes.AXOLOTL, statueSettings, WAXED_CLEAN_AXOLOTL_STATUE, WAXED_EXPOSED_AXOLOTL_STATUE, WAXED_DIRTY_AXOLOTL_STATUE, WAXED_MOSSY_AXOLOTL_STATUE, WAXED_VERY_MOSSY_AXOLOTL_STATUE);
    ...
    public static void initStatues() {
        ...
        registerStatues("axolotl", AXOLOTL_STATUE, WAXED_CLEAN_AXOLOTL_STATUE, WAXED_EXPOSED_AXOLOTL_STATUE, WAXED_DIRTY_AXOLOTL_STATUE, WAXED_MOSSY_AXOLOTL_STATUE, WAXED_VERY_MOSSY_AXOLOTL_STATUE);
